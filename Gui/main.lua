    ...
    [17] = function()
        ...
        return function(t)
            ...
            v.Root =
                s(
                "Frame",
                {BackgroundTransparency = 1, ZIndex = 125, Size = v.Size, Position = UDim2.fromOffset(550, 250), AnchorPoint = Vector2.new(0.5,0.5), Parent = t.Parent},
            ...
            v.Maximize = function(M, N, O)
                ...
                if M then
                    K = v.Size.X.Scale > 0 and v.Size.X.Scale or v.Size.X.Offset
                    L = v.Size.Y.Scale > 0 and v.Size.Y.Scale or v.Size.Y.Offset
                end
                ...
                if not N then
                    H:setGoal {
                        X = q(M and 450 or 550, {frequency = 6}),
                        Y = q(M and 350 or 250, {frequency = 6})
                    }
                end
            end
            m.AddSignal(
